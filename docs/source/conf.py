...
# -*- coding: utf-8 -*-
#
# djiocode documentation build configuration file
#
...
latex_documents = [
    (master_doc, 'djiocode.tex', 'djiocode Documentation',
     'patdaburu', 'manual'),
]
...
man_pages = [
    (master_doc, 'djiocode', 'djiocode Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'djiocode', 'djiocode Documentation',
     author, 'djiocode', 'One line description of project.',
     'Miscellaneous'),
]
