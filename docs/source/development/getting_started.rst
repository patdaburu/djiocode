...
The source code for the `djiocode` project lives at
`github <https://github.com/patdaburu/djiocode>`_.  You can use `git clone` to get it.

.. code-block:: bash

   git clone https://github.com/patdaburu/djiocode
